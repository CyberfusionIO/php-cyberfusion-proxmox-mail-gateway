...
class CreateRuleRequest
{
     ...
     * @param int $priority Rule priority. (0 - 100)
     * @param bool|null $active Flag to activate rule.
     * @param int|null $direction Rule direction. Value `0` matches incoming mails, value `1` matches outgoing mails, and value `2` matches both directions. (0 - 2)
